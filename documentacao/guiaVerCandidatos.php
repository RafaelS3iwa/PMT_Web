...
<main>
    ...
    <div class="blocoFormRoxo">
        ...
        <div>
            ...
            <p class="texto-guia">Ao fazer login no seu Dashboard PMT, você encontrará uma visão geral elegante e intuitiva. É aqui que a mágica acontece.</p>
        </div>
        <div>
            <h4 class="titulo-topico">Passo 2: Vagas e Candidatos em Destaque:</h4>
            <p class="texto-guia">Cada vaga que você criou será destacada, com a lista de candidatos que expressaram interesse logo ao lado. Tudo em um único local, para máxima conveniência.</p>
        </div>
        <div>
            <h4 class="titulo-topico">Passo 3: Detalhes Personalizados:</h4>
            <p class="texto-guia">Clique em qualquer vaga para explorar detalhes mais aprofundados. Veja quem está por trás do interesse e descubra mais sobre o potencial que aguarda sua empresa.</p>
        </div>
        <div>
