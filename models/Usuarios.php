...
class Usuario
{
    ...
    {
        try {
            $query = "SELECT id_usuario, nome_completo, nome_social, data_nascimento, email FROM usuarios WHERE id_usuario =:id_usuario";
    ...
    public static function getIdCandidato($id_usuario)
    {
        try {
            $query = "SELECT id_candidato FROM candidatos WHERE id_usuario = :id_usuario";
            $conexao = DBConexao::getConexao();
            ...
            echo 'Erro ao obter o id_candidato: ' . $e->getMessage();
            return false;
        }
    }
